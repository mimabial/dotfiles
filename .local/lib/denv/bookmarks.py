...
class XDGPaths:
    def __init__(self):
        ...
        self.CACHE_DIR = os.path.join(self.xdg_cache, "denv")
        self.CONFIG_DIR = os.path.join(self.xdg_config, "denv")
        self.RUNTIME_DIR = os.path.join(self.xdg_runtime, "denv")
        self.DATA_DIR = os.path.join(self.xdg_data, "denv")
...
class BookmarkManager:
    ...
    def find_bookmark_files(self):
        ...
        # Custom .lst files
        for path in [
            os.path.join(self.xdg.xdg_config, "denv/bookmarks.lst"),
        ]:
            if os.path.exists(path):
                files.append(path)
        return files

  ...
  "widget-config": {
    ...
    "buttons-grid": {
      "actions": [
				...
				{
					"label":"󱡽",
					"command": "bash -c hyde-shell airplaneMode",
					"type": "toggle"
				},
				{
					"label":"",
				...
				{
					"label": "",
					"command": "bash -c hyde-shell wlogout"
				}
      ]
    }
  }
...
# Generate style.css
cat <<WARN >"${swayncDir}/style.css"
/* ========================================================================
   WARNING: This file is auto-generated by '${WALLBASH_SCRIPTS}/swaync.sh'.
   DO NOT edit manually.
   For user configuration edit '${confDir}/swaync/style-user.css' then run 'hyde-shell wallbash swaync' to apply changes.
======================================================================== */

/* ========================================================================
   COLOR PALETTE - Import theme colors 
======================================================================== */

@import url('file://${confDir}/swaync/theme.css');
...
* {
  outline: none;
  font-family: "${font_name:-Iosevka Nerd Font}", monospace;
...
.close-button {
  margin-top: 1.1rem;
  background-color: alpha(@bg-tertiary, 0);
}
...
======================================================================== */
.notification-group {
  background-color: alpha(@bg-tertiary, 0.6);
  padding-top: 10px;
}
...
.notification-group-icon {
  -gtk-icon-transform: scale(0); /* A more direct GTK way to hide it */
  min-width: 0;
  min-height: 0;
  margin: 0;
  padding: 0;
...
# Append user style CSS if it exists
if [ -f "${confDir}/swaync/style-user.css" ]; then
  cat "${confDir}/swaync/style-user.css" >>"${swayncDir}/style.css"
fi

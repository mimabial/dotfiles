...
if (( $# != 2 )) || [[ -z $card || -z $profile ]]; then
  echo "Usage: audio-profile-transition.sh <card> <profile>" >&2
  exit 1
fi
...
profile_state=$("$script_dir/audio-cards.sh" |

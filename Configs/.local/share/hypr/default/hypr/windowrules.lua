...
hl.window_rule({["name"] = "lua:windowrules:34", ["match"] = {["class"] = "^(thunar)$"}, ["opacity"] = "0.80 override 0.80 override 1"})
...
hl.window_rule({["name"] = "lua:windowrules:64", ["match"] = {["class"] = "^(org\\.gnome\\.gThumb)$"}, ["suppress_event"] = "fullscreen"})
hl.window_rule({["name"] = "lua:windowrules:65", ["match"] = {["class"] = "^(org\\.gnome\\.gThumb)$", ["modal"] = false}, ["fullscreen"] = true})

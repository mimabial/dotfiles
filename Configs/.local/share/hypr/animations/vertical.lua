...
hl.animation({["leaf"] = "workspaces", ["enabled"] = true, ["speed"] = 3.0, ["bezier"] = "fluent_decel", ["style"] = "slidefadevert 30%"})
hl.animation({["leaf"] = "specialWorkspace", ["enabled"] = true, ["speed"] = 2.0, ["bezier"] = "fluent_decel", ["style"] = "slidefade 10%"})

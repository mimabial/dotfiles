" Name:         pywal16
" Description:  pywal16 colorscheme
" Last Change:  April 2025

if exists('g:loaded_pywal16') | finish | endif
let g:loaded_pywal16 = 1
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  ...
  if s:is_dark
    let g:terminal_ansi_colors = ['111212', 'A39265', '7AC2C2', '7AA8C2',
                                \ '658AA3', '9ACAE6', '9AE6E6', 'FFFFFF',
                                \ '232D34', 'C2AE7A', '9AE6E6', 'AAD6F0',
                                \ '7AA4C2', 'AAD6F0', 'AAF0F0', 'FFFFFF']
  else
    " Lighter colors for light theme
    let g:terminal_ansi_colors = ['FFFFFF', 'E6D09A', 'AAF0F0', 'AAD6F0',
                                \ '9AC6E6', 'CCECFF', 'CCFFFF', '3F4D55',
                                \ 'FFFFFF', 'F0DCAA', 'CCFFFF', 'CCECFF',
                                \ 'AAD3F0', 'CCECFF', 'CCFFFF', '111212']
  endif
...
augroup Pywal16DynamicHighlight
  autocmd!
  " Update selection highlight when pywal16 colors change
  autocmd ColorScheme pywal16 call s:update_dynamic_highlights()
augroup END
...
if &background == 'dark'
  ...
  hi Pmenu guibg=#3F4D55 guifg=#FFFFFF gui=NONE cterm=NONE
  hi StatusLine guifg=#FFFFFF guibg=#3F4D55 gui=NONE cterm=NONE
  hi StatusLineNC guifg=#FFFFFF guibg=#232D34 gui=NONE cterm=NONE
  ...
  hi NeoTreeWinSeparator guifg=#232D34 guibg=NONE gui=NONE cterm=NONE
  ...
  hi TabLine guifg=#FFFFFF guibg=#3F4D55 gui=NONE cterm=NONE
  hi TabLineFill guifg=NONE guibg=NONE gui=NONE cterm=NONE
  hi TabLineSel guifg=#111212 guibg=#CCFFFF gui=bold cterm=bold
  hi TabLineSeparator guifg=#65A3A3 guibg=#3F4D55 gui=NONE cterm=NONE

  " Interactive elements with dynamic contrast
  hi Search guifg=#232D34 guibg=#AAF0F0 gui=NONE cterm=NONE
  hi Visual guifg=#232D34 guibg=#9AE6E6 gui=NONE cterm=NONE
  hi MatchParen guifg=#232D34 guibg=#CCFFFF gui=bold cterm=bold
  ...
  hi WhichKeyFloat guibg=#232D34 guifg=NONE gui=NONE cterm=NONE

  " Selection and hover highlights with inverted colors
  hi CursorColumn guifg=NONE guibg=#3F4D55 gui=NONE cterm=NONE
  hi Cursor guibg=#FFFFFF guifg=#111212 gui=NONE cterm=NONE
  hi lCursor guibg=#FFFFFF guifg=#111212 gui=NONE cterm=NONE
  hi CursorIM guibg=#FFFFFF guifg=#111212 gui=NONE cterm=NONE
  hi TermCursor guibg=#FFFFFF guifg=#111212 gui=NONE cterm=NONE
  hi TermCursorNC guibg=#FFFFFF guifg=#111212 gui=NONE cterm=NONE
  ...
  hi QuickFixLine guifg=#232D34 guibg=#9AE6E6 gui=NONE cterm=NONE
  hi IncSearch guifg=#232D34 guibg=#CCFFFF gui=NONE cterm=NONE
  hi NormalNC guibg=#232D34 guifg=#FFFFFF gui=NONE cterm=NONE
  hi Directory guifg=#AAF0F0 guibg=NONE gui=NONE cterm=NONE
  hi WildMenu guifg=#232D34 guibg=#CCFFFF gui=bold cterm=bold

  " Add highlight groups for focused items with inverted colors
  hi CursorLineFold guifg=#CCFFFF guibg=#232D34 gui=NONE cterm=NONE
  hi FoldColumn guifg=#FFFFFF guibg=NONE gui=NONE cterm=NONE
  hi Folded guifg=#FFFFFF guibg=#3F4D55 gui=italic cterm=italic
  ...
  hi NeoTreeGitDeleted guifg=#A39265 guibg=NONE gui=NONE cterm=NONE
  hi NeoTreeGitUntracked guifg=#7AA8C2 guibg=NONE gui=NONE cterm=NONE
  ...
  " hi NeoTreeCursorLine guibg=#9AE6E6 guifg=#111212 gui=bold cterm=bold
  " hi! link NeoTreeCursor NeoTreeCursorLine
  " hi! link NeoTreeCursorLineSign NeoTreeCursorLine

  " Use pywal16 colors for explorer snack in dark mode
  hi WinBar guifg=#FFFFFF guibg=#3F4D55 gui=bold cterm=bold
  hi WinBarNC guifg=#FFFFFF guibg=#232D34 gui=NONE cterm=NONE
  hi ExplorerSnack guibg=#CCFFFF guifg=#111212 gui=bold cterm=bold
  hi BufferTabpageFill guibg=#111212 guifg=#FFFFFF gui=NONE cterm=NONE
  ...
  hi BufferCurrentSign guifg=#CCFFFF guibg=#232D34 gui=NONE cterm=NONE
  hi BufferVisible guifg=#FFFFFF guibg=#3F4D55 gui=NONE cterm=NONE
  hi BufferVisibleMod guifg=#FFFFFF guibg=#3F4D55 gui=NONE cterm=NONE
  hi BufferVisibleSign guifg=#9AE6E6 guibg=#232D34 gui=NONE cterm=NONE
  hi BufferInactive guifg=#FFFFFF guibg=#232D34 gui=NONE cterm=NONE
  hi BufferInactiveMod guifg=#65A3A3 guibg=#232D34 gui=NONE cterm=NONE
  hi BufferInactiveSign guifg=#65A3A3 guibg=#232D34 gui=NONE cterm=NONE
  ...
  hi Normal guibg=NONE guifg=#111212 gui=NONE cterm=NONE
  hi Pmenu guibg=#FFFFFF guifg=#111212 gui=NONE cterm=NONE
  hi StatusLine guifg=#FFFFFF guibg=#4B6B7D gui=NONE cterm=NONE
  hi StatusLineNC guifg=#111212 guibg=#FFFFFF gui=NONE cterm=NONE
  hi VertSplit guifg=#4B6B7D guibg=NONE gui=NONE cterm=NONE
  hi LineNr guifg=#4B6B7D guibg=NONE gui=NONE cterm=NONE
  hi SignColumn guifg=NONE guibg=NONE gui=NONE cterm=NONE
  hi FoldColumn guifg=#232D34 guibg=NONE gui=NONE cterm=NONE

  " NeoTree with transparent background including unfocused state
  hi NeoTreeNormal guibg=NONE guifg=#111212 gui=NONE cterm=NONE
  hi NeoTreeEndOfBuffer guibg=NONE guifg=#111212 gui=NONE cterm=NONE
  hi NeoTreeFloatNormal guibg=NONE guifg=#111212 gui=NONE cterm=NONE
  hi NeoTreeFloatBorder guifg=#4B687D guibg=NONE gui=NONE cterm=NONE
  hi NeoTreeWinSeparator guifg=#FFFFFF guibg=NONE gui=NONE cterm=NONE

  " NeoTree with transparent background
  hi NeoTreeNormal guibg=NONE guifg=#111212 gui=NONE cterm=NONE
  hi NeoTreeEndOfBuffer guibg=NONE guifg=#111212 gui=NONE cterm=NONE
  hi NeoTreeRootName guifg=#294152 guibg=NONE gui=bold cterm=bold

  " TabLine highlighting with complementary accents
  hi TabLine guifg=#111212 guibg=#FFFFFF gui=NONE cterm=NONE
  hi TabLineFill guifg=NONE guibg=NONE gui=NONE cterm=NONE
  hi TabLineSel guifg=#FFFFFF guibg=#294152 gui=bold cterm=bold
  hi TabLineSeparator guifg=#4B6B7D guibg=#FFFFFF gui=NONE cterm=NONE

  " Interactive elements with complementary contrast
  hi Search guifg=#FFFFFF guibg=#3A576B gui=NONE cterm=NONE
  hi Visual guifg=#FFFFFF guibg=#4B6B7D gui=NONE cterm=NONE
  hi MatchParen guifg=#FFFFFF guibg=#294152 gui=bold cterm=bold

  " Menu item hover highlight
  hi CmpItemAbbrMatch guifg=#294152 guibg=NONE gui=bold cterm=bold
  hi CmpItemAbbrMatchFuzzy guifg=#3A576B guibg=NONE gui=bold cterm=bold
  hi CmpItemMenu guifg=#232D34 guibg=NONE gui=italic cterm=italic
  hi CmpItemAbbr guifg=#111212 guibg=NONE gui=NONE cterm=NONE
  hi CmpItemAbbrDeprecated guifg=#3F4D55 guibg=NONE gui=strikethrough cterm=strikethrough

  " Specific menu highlight groups
  hi WhichKey guifg=#294152 guibg=NONE gui=NONE cterm=NONE
  hi WhichKeySeparator guifg=#3F4D55 guibg=NONE gui=NONE cterm=NONE
  hi WhichKeyGroup guifg=#4B687D guibg=NONE gui=NONE cterm=NONE
  hi WhichKeyDesc guifg=#3A576B guibg=NONE gui=NONE cterm=NONE
  hi WhichKeyFloat guibg=#FFFFFF guifg=NONE gui=NONE cterm=NONE

  " Selection and hover highlights with inverted colors
  hi CursorColumn guifg=NONE guibg=#FFFFFF gui=NONE cterm=NONE
  hi Cursor guibg=#111212 guifg=#FFFFFF gui=NONE cterm=NONE
  hi lCursor guibg=#FFFFFF guifg=#111212 gui=NONE cterm=NONE
  hi CursorIM guibg=#FFFFFF guifg=#111212 gui=NONE cterm=NONE
  hi TermCursor guibg=#111212 guifg=#FFFFFF gui=NONE cterm=NONE
  hi TermCursorNC guibg=#FFFFFF guifg=#111212 gui=NONE cterm=NONE
  hi CursorLine guibg=NONE ctermbg=NONE gui=underline cterm=underline
  hi CursorLineNr guifg=#294152 guibg=NONE gui=bold cterm=bold

  hi QuickFixLine guifg=#FFFFFF guibg=#3A576B gui=NONE cterm=NONE
  hi IncSearch guifg=#FFFFFF guibg=#294152 gui=NONE cterm=NONE
  hi NormalNC guibg=#FFFFFF guifg=#232D34 gui=NONE cterm=NONE
  hi Directory guifg=#294152 guibg=NONE gui=NONE cterm=NONE
  hi WildMenu guifg=#FFFFFF guibg=#294152 gui=bold cterm=bold

  " Add highlight groups for focused items with inverted colors
  hi CursorLineFold guifg=#294152 guibg=#FFFFFF gui=NONE cterm=NONE
  hi FoldColumn guifg=#232D34 guibg=NONE gui=NONE cterm=NONE
  hi Folded guifg=#111212 guibg=#FFFFFF gui=italic cterm=italic

  " File explorer specific highlights
  hi NeoTreeNormal guibg=NONE guifg=#111212 gui=NONE cterm=NONE
  hi NeoTreeEndOfBuffer guibg=NONE guifg=#111212 gui=NONE cterm=NONE
  hi NeoTreeRootName guifg=#294152 guibg=NONE gui=bold cterm=bold
  hi NeoTreeFileName guifg=#111212 guibg=NONE gui=NONE cterm=NONE
  hi NeoTreeFileIcon guifg=#3A576B guibg=NONE gui=NONE cterm=NONE
  hi NeoTreeDirectoryName guifg=#3A576B guibg=NONE gui=NONE cterm=NONE
  hi NeoTreeDirectoryIcon guifg=#3A576B guibg=NONE gui=NONE cterm=NONE
  hi NeoTreeGitModified guifg=#4B687D guibg=NONE gui=NONE cterm=NONE
  hi NeoTreeGitAdded guifg=#577B8F guibg=NONE gui=NONE cterm=NONE
  hi NeoTreeGitDeleted guifg=#A39265 guibg=NONE gui=NONE cterm=NONE
  hi NeoTreeGitUntracked guifg=#7AA8C2 guibg=NONE gui=NONE cterm=NONE
  hi NeoTreeIndentMarker guifg=#57788F guibg=NONE gui=NONE cterm=NONE
  hi NeoTreeSymbolicLinkTarget guifg=#4B687D guibg=NONE gui=NONE cterm=NONE

  " File explorer cursor highlights with strong contrast
  " hi NeoTreeCursorLine guibg=#3A576B guifg=#FFFFFF gui=bold cterm=bold
  " hi! link NeoTreeCursor NeoTreeCursorLine
  " hi! link NeoTreeCursorLineSign NeoTreeCursorLine

  " Use pywal16 colors for explorer snack in light mode
  hi WinBar guifg=#111212 guibg=#FFFFFF gui=bold cterm=bold
  hi WinBarNC guifg=#232D34 guibg=#FFFFFF gui=NONE cterm=NONE
  hi ExplorerSnack guibg=#294152 guifg=#FFFFFF gui=bold cterm=bold
  hi BufferTabpageFill guibg=#FFFFFF guifg=#3F4D55 gui=NONE cterm=NONE
  hi BufferCurrent guifg=#FFFFFF guibg=#294152 gui=bold cterm=bold
  hi BufferCurrentMod guifg=#FFFFFF guibg=#4B687D gui=bold cterm=bold
  hi BufferCurrentSign guifg=#294152 guibg=#FFFFFF gui=NONE cterm=NONE
  hi BufferVisible guifg=#111212 guibg=#FFFFFF gui=NONE cterm=NONE
  hi BufferVisibleMod guifg=#232D34 guibg=#FFFFFF gui=NONE cterm=NONE
  hi BufferVisibleSign guifg=#4B687D guibg=#FFFFFF gui=NONE cterm=NONE
  hi BufferInactive guifg=#3F4D55 guibg=#FFFFFF gui=NONE cterm=NONE
  hi BufferInactiveMod guifg=#658AA3 guibg=#FFFFFF gui=NONE cterm=NONE
  hi BufferInactiveSign guifg=#658AA3 guibg=#FFFFFF gui=NONE cterm=NONE
...
hi FloatBorder guifg=#4B6B7D guibg=NONE gui=NONE cterm=NONE
hi SignColumn guifg=NONE guibg=NONE gui=NONE cterm=NONE
hi DiffAdd guifg=#FFFFFF guibg=#7AC2C2 gui=NONE cterm=NONE
hi DiffChange guifg=#FFFFFF guibg=#658DA3 gui=NONE cterm=NONE
hi DiffDelete guifg=#FFFFFF guibg=#A39265 gui=NONE cterm=NONE
hi TabLineFill guifg=NONE guibg=NONE gui=NONE cterm=NONE

" Fix selection highlighting with proper color derivatives
hi TelescopeSelection guibg=#CCECFF guifg=#111212 gui=bold cterm=bold
hi TelescopeSelectionCaret guifg=#FFFFFF guibg=#CCECFF gui=bold cterm=bold
hi TelescopeMultiSelection guibg=#9ACAE6 guifg=#111212 gui=bold cterm=bold
hi TelescopeMatching guifg=#C2AE7A guibg=NONE gui=bold cterm=bold

" Minimal fix for explorer selection highlighting
hi NeoTreeCursorLine guibg=#CCECFF guifg=#111212 gui=bold

" Fix for LazyVim menu selection highlighting
hi Visual guibg=#FFF1CC guifg=#111212 gui=bold
hi CursorLine guibg=NONE ctermbg=NONE gui=underline cterm=underline
hi PmenuSel guibg=#FFF1CC guifg=#111212 gui=bold
hi WildMenu guibg=#FFF1CC guifg=#111212 gui=bold

" Create improved autocommands to ensure highlighting persists with NeoTree focus fixes
augroup Pywal16SelectionFix
  autocmd!
...
augroup FixNeoTreeBackground
  ...
  autocmd ColorScheme,VimEnter * if &background == 'dark' |
    \ hi NeoTreeCursorLine guibg=#CCECFF guifg=#111212 gui=bold cterm=bold |
    \ hi NvimTreeCursorLine guibg=#CCECFF guifg=#111212 gui=bold cterm=bold |
    \ else |
    \ hi NeoTreeCursorLine guibg=#294152 guifg=#FFFFFF gui=bold cterm=bold |
    \ hi NvimTreeCursorLine guibg=#294152 guifg=#FFFFFF gui=bold cterm=bold |
    \ endif

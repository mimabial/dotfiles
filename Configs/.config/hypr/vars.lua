...
local values = {
    ...
    TERMINAL_TUI = "foot",
    LOCKSCREEN = "hyprlock",
    ["list.environment"] = "WAYLAND_DISPLAY XDG_RUNTIME_DIR HYPRLAND_INSTANCE_SIGNATURE XDG_CURRENT_DESKTOP XDG_SESSION_TYPE XDG_SESSION_DESKTOP XDG_CONFIG_HOME QT_QPA_PLATFORM QT_QPA_PLATFORMTHEME QT_STYLE_OVERRIDE QT_FONT_DPI XCURSOR_THEME XCURSOR_SIZE XCURSOR_PATH",
    ...
    ["start.REMOVABLE_MEDIA"] = "hyprshell system/start-if-available.sh HYPR_START_REMOVABLE_MEDIA udiskie -- hyprshell app -t service udiskie --smart-tray",
    ...
    ["start.TORRENT"] = "hyprshell system/start-if-vpn.sh --timeout 90 --workspace special -- qbittorrent",

...
BarGroup {
    ...
    shell: root.shell; css: "colormode-group"; Layout.fillWidth: true
    holdOpen: ["colormode", "colorpicker"].includes(root.shell.popupName)
    primary: Component { ScriptButton {
        id: colorButton; Layout.fillWidth: true; shell: root.shell; css: "colormode"; tooltip: ""; command: ["hyprshell", "quickshell/color-mode"]; interval: 86400000; refreshKey: root.shell.palette

...
BarGroup {
    ...
    primary: Component { BarButton {
        shell: root.shell; css: "dmark"; text: "—"
    ...
    Component { id: gpuView; GpuReadout { shell: root.shell; popupsAllowed: root.popupsAllowed } }
    Component { id: cpuView; CpuReadout { shell: root.shell; popupsAllowed: root.popupsAllowed } }
    Component { id: memoryView; MemoryReadout { shell: root.shell; popupsAllowed: root.popupsAllowed } }
    Component { id: diskView; DiskReadout { shell: root.shell; popupsAllowed: root.popupsAllowed } }
}

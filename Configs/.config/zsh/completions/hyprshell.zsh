...
_hyprshell() {
    ...
    built_in_commands=("--help" "help" "-h" "-r" "reload" "--version" "version" "-v" "--release-notes" "release-notes" "list" "--list-script" "--list-script-path" "--completions" "completions" "pyinit" "init" "--init" "lock-session" "logout" "pip" "pypr" "app" "resolve" )

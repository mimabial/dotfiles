...
def main():
    ...
    config_file = os.path.join(xdg_state_home(), "hydra", "config")
    colors_file = os.path.join(xdg_cache_home(), "hydra/wall.dcol")
    ...
    # You can configure these in ~/.config/hydra/config.toml

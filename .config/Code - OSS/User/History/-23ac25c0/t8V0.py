...
def get_var(theme_var: str, file: Optional[str] = None) -> Optional[str]:
    ...
    default_configs = [
        Path(xdg_data_home) / "hydra/hydra.conf",
        Path(xdg_data_home) / "hydra/hyprland.conf",
        Path("/usr/local/share/hydra/hydra.conf"),
        Path("/usr/local/share/hydra/hyprland.conf"),
        Path("/usr/share/hydra/hydra.conf"),

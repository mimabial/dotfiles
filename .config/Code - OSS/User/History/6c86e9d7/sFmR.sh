...
# ! export XDG_DATA_DIRS="$XDG_DATA_HOME/hydra:/usr/local/share/hydra/:/usr/share/hydra/:$XDG_DATA_DIRS" # Causes issues https://github.com/HyDE-Project/HyDE/issues/308#issuecomment-2691229673

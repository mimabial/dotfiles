...
if pkg_installed sddm; then
    ...
    if [ ! -f /etc/sddm.conf.d/backup_the_hydra_project.conf ] || [ "${HYDRA_INSTALL_SDDM}" = true ]; then
        ...
        *) sddmtheme="Corners" ;;
        ...
        sudo touch /etc/sddm.conf.d/the_hydra_project.conf
        sudo cp /etc/sddm.conf.d/the_hydra_project.conf /etc/sddm.conf.d/backup_the_hydra_project.conf
        sudo cp /usr/share/sddm/themes/${sddmtheme}/the_hydra_project.conf /etc/sddm.conf.d/
    else

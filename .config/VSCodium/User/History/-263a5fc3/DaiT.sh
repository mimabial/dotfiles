...
gpuinfo_file="/tmp/hydra-${UID}-gpuinfo"
...
get_temp_color() {
  ...
  declare -A temp_colors=(
    ...
    [40]="#1b7d4f" # Light Blue for 40 to 44
    [30]="#066839" # Steel Blue for 30 to 34
    [20]="#0f5132" # Blue for 20 to 24
    [0]="#18392b"  # Dark Blue for below 20
  )

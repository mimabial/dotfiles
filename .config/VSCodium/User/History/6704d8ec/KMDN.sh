...
# sed '1d' "${HYDRA_THEME_DIR}/hypr.theme" >"${confDir}/hypr/themes/theme.conf"

# Validate the theme configuration file
cat <<WALLBASH >"${confDir}/hypr/themes/wallbash.conf"
# Auto-generated by Hydra // Read-only
# // ----------------------------
# Hydra Theme: ${HYDRA_THEME}
# Configuration File: "${HYDRA_THEME_DIR}/hypr.theme"
...
# exec = \${RUN_CMD}"
# source = \${SOURCE_FILE}
# exec = hydra-shell walbash code \$CODE_THEME # Setting the code theme

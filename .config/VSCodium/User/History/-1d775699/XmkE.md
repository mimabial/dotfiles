...
This document provides an explanation of the color configuration used for theming Hydra. It covers primary colors, text colors, and accent colors. Each color can be specified in either hexadecimal or RGBA format.

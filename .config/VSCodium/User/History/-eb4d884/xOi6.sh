...
export b_radius=$((b_height * 10 / 100)) # block rad 70% of height (type1)
...
export g_paddin=$((b_height * 10 / 100)) # module padding 15% of height
export w_radius=$((b_height * 5 / 100)) # workspace rad 5% of height
export w_margin=$((b_height * 0 / 100)) # workspace margin 10% of height
export w_paddin=$((b_height * 30 / 100)) # workspace padding 10% of height
export w_padalt=$((b_height * 15 / 100)) # workspace padding 10% of height
export w_padact=$((b_height * 10 / 100)) # workspace active padding 40% of height

...
export w_radius=$((b_height * 5 / 100)) # workspace rad 30% of height
export w_margin=$((b_height * 0 / 100)) # workspace margin 10% of height
export w_paddin=$((b_height * 25 / 100)) # workspace padding 10% of height
...
export s_fontpx=$((b_height * 35 / 100)) # font size 34% of height

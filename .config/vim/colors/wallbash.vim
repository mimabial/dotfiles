...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  ...
  if s:is_dark
    let g:terminal_ansi_colors = ['2F3B4B', 'A38665', '7A99C2', '7AA5C2', 
                                \ '6585A3', '9AC7E6', '9ABAE6', 'FFFFFF',
                                \ '324D67', 'C2A07A', '9ABAE6', 'AAD4F0', 
                                \ '7A9FC2', 'AAD4F0', 'AAC8F0', 'FFFFFF']
  else
    " Lighter colors for light theme
    let g:terminal_ansi_colors = ['FFFFFF', 'E6C29A', 'AAC8F0', 'AAD4F0', 
                                \ '9AC0E6', 'CCEAFF', 'CCE2FF', '376686',
                                \ 'FFFFFF', 'F0CFAA', 'CCE2FF', 'CCEAFF', 
                                \ 'AACEF0', 'CCEAFF', 'CCE2FF', '2F3B4B']
  endif
...
if &background == 'dark'
  ...
  hi Pmenu guibg=#376686 guifg=#FFFFFF gui=NONE cterm=NONE
  hi StatusLine guifg=#FFFFFF guibg=#376686 gui=NONE cterm=NONE
  hi StatusLineNC guifg=#FFFFFF guibg=#324D67 gui=NONE cterm=NONE
  ...
  hi NeoTreeWinSeparator guifg=#324D67 guibg=NONE gui=NONE cterm=NONE
  ...
  hi TabLine guifg=#FFFFFF guibg=#376686 gui=NONE cterm=NONE
  hi TabLineFill guifg=NONE guibg=NONE gui=NONE cterm=NONE
  hi TabLineSel guifg=#2F3B4B guibg=#CCE2FF gui=bold cterm=bold
  hi TabLineSeparator guifg=#6580A3 guibg=#376686 gui=NONE cterm=NONE
  
  " Interactive elements with dynamic contrast
  hi Search guifg=#324D67 guibg=#AAC8F0 gui=NONE cterm=NONE
  hi Visual guifg=#324D67 guibg=#9ABAE6 gui=NONE cterm=NONE
  hi MatchParen guifg=#324D67 guibg=#CCE2FF gui=bold cterm=bold
  ...
  hi WhichKeyFloat guibg=#324D67 guifg=NONE gui=NONE cterm=NONE
  
  " Selection and hover highlights with inverted colors
  hi CursorColumn guifg=NONE guibg=#376686 gui=NONE cterm=NONE
  hi Cursor guibg=#FFFFFF guifg=#2F3B4B gui=NONE cterm=NONE
  hi lCursor guibg=#FFFFFF guifg=#2F3B4B gui=NONE cterm=NONE
  hi CursorIM guibg=#FFFFFF guifg=#2F3B4B gui=NONE cterm=NONE
  hi TermCursor guibg=#FFFFFF guifg=#2F3B4B gui=NONE cterm=NONE
  hi TermCursorNC guibg=#FFFFFF guifg=#2F3B4B gui=NONE cterm=NONE
  ...
  hi QuickFixLine guifg=#324D67 guibg=#9ABAE6 gui=NONE cterm=NONE
  hi IncSearch guifg=#324D67 guibg=#CCE2FF gui=NONE cterm=NONE
  hi NormalNC guibg=#324D67 guifg=#FFFFFF gui=NONE cterm=NONE
  hi Directory guifg=#AAC8F0 guibg=NONE gui=NONE cterm=NONE
  hi WildMenu guifg=#324D67 guibg=#CCE2FF gui=bold cterm=bold
  
  " Add highlight groups for focused items with inverted colors
  hi CursorLineFold guifg=#CCE2FF guibg=#324D67 gui=NONE cterm=NONE
  hi FoldColumn guifg=#FFFFFF guibg=NONE gui=NONE cterm=NONE
  hi Folded guifg=#FFFFFF guibg=#376686 gui=italic cterm=italic
  ...
  hi NeoTreeGitDeleted guifg=#A38665 guibg=NONE gui=NONE cterm=NONE
  hi NeoTreeGitUntracked guifg=#7AA5C2 guibg=NONE gui=NONE cterm=NONE
  ...
  " hi NeoTreeCursorLine guibg=#9ABAE6 guifg=#2F3B4B gui=bold cterm=bold
  ...
  hi WinBar guifg=#FFFFFF guibg=#376686 gui=bold cterm=bold
  hi WinBarNC guifg=#FFFFFF guibg=#324D67 gui=NONE cterm=NONE
  hi ExplorerSnack guibg=#CCE2FF guifg=#2F3B4B gui=bold cterm=bold
  hi BufferTabpageFill guibg=#2F3B4B guifg=#FFFFFF gui=NONE cterm=NONE
  ...
  hi BufferCurrentSign guifg=#CCE2FF guibg=#324D67 gui=NONE cterm=NONE
  hi BufferVisible guifg=#FFFFFF guibg=#376686 gui=NONE cterm=NONE
  hi BufferVisibleMod guifg=#FFFFFF guibg=#376686 gui=NONE cterm=NONE
  hi BufferVisibleSign guifg=#9ABAE6 guibg=#324D67 gui=NONE cterm=NONE
  hi BufferInactive guifg=#FFFFFF guibg=#324D67 gui=NONE cterm=NONE
  hi BufferInactiveMod guifg=#6580A3 guibg=#324D67 gui=NONE cterm=NONE
  hi BufferInactiveSign guifg=#6580A3 guibg=#324D67 gui=NONE cterm=NONE
  ...
  hi Normal guibg=NONE guifg=#2F3B4B gui=NONE cterm=NONE
  hi Pmenu guibg=#FFFFFF guifg=#2F3B4B gui=NONE cterm=NONE
  hi StatusLine guifg=#FFFFFF guibg=#4B697D gui=NONE cterm=NONE
  hi StatusLineNC guifg=#2F3B4B guibg=#FFFFFF gui=NONE cterm=NONE
  hi VertSplit guifg=#4B697D guibg=NONE gui=NONE cterm=NONE
  hi LineNr guifg=#4B697D guibg=NONE gui=NONE cterm=NONE
  hi SignColumn guifg=NONE guibg=NONE gui=NONE cterm=NONE
  hi FoldColumn guifg=#324D67 guibg=NONE gui=NONE cterm=NONE
  
  " NeoTree with transparent background including unfocused state
  hi NeoTreeNormal guibg=NONE guifg=#2F3B4B gui=NONE cterm=NONE
  hi NeoTreeEndOfBuffer guibg=NONE guifg=#2F3B4B gui=NONE cterm=NONE
  hi NeoTreeFloatNormal guibg=NONE guifg=#2F3B4B gui=NONE cterm=NONE
  ...
  " TabLine highlighting with complementary accents
  hi TabLine guifg=#2F3B4B guibg=#FFFFFF gui=NONE cterm=NONE
  hi TabLineFill guifg=NONE guibg=NONE gui=NONE cterm=NONE
  hi TabLineSel guifg=#FFFFFF guibg=#293E52 gui=bold cterm=bold
  hi TabLineSeparator guifg=#4B697D guibg=#FFFFFF gui=NONE cterm=NONE
  
  " Interactive elements with complementary contrast
  hi Search guifg=#FFFFFF guibg=#3A536B gui=NONE cterm=NONE
  hi Visual guifg=#FFFFFF guibg=#4B697D gui=NONE cterm=NONE
  ...
  hi CmpItemMenu guifg=#324D67 guibg=NONE gui=italic cterm=italic
  hi CmpItemAbbr guifg=#2F3B4B guibg=NONE gui=NONE cterm=NONE
  hi CmpItemAbbrDeprecated guifg=#376686 guibg=NONE gui=strikethrough cterm=strikethrough
  
  " Specific menu highlight groups
  hi WhichKey guifg=#293E52 guibg=NONE gui=NONE cterm=NONE
  hi WhichKeySeperator guifg=#376686 guibg=NONE gui=NONE cterm=NONE
  ...
  hi Cursor guibg=#2F3B4B guifg=#FFFFFF gui=NONE cterm=NONE
  hi lCursor guibg=#FFFFFF guifg=#2F3B4B gui=NONE cterm=NONE
  hi CursorIM guibg=#FFFFFF guifg=#2F3B4B gui=NONE cterm=NONE
  hi TermCursor guibg=#2F3B4B guifg=#FFFFFF gui=NONE cterm=NONE
  hi TermCursorNC guibg=#FFFFFF guifg=#2F3B4B gui=NONE cterm=NONE
  hi CursorLine guibg=NONE ctermbg=NONE gui=underline cterm=underline
  ...
  hi NormalNC guibg=#FFFFFF guifg=#324D67 gui=NONE cterm=NONE
  ...
  hi FoldColumn guifg=#324D67 guibg=NONE gui=NONE cterm=NONE
  hi Folded guifg=#2F3B4B guibg=#FFFFFF gui=italic cterm=italic

  " File explorer specific highlights
  hi NeoTreeNormal guibg=NONE guifg=#2F3B4B gui=NONE cterm=NONE
  hi NeoTreeEndOfBuffer guibg=NONE guifg=#2F3B4B gui=NONE cterm=NONE
  hi NeoTreeRootName guifg=#293E52 guibg=NONE gui=bold cterm=bold
  hi NeoTreeFileName guifg=#2F3B4B guibg=NONE gui=NONE cterm=NONE
  ...
  hi NeoTreeGitAdded guifg=#57788F guibg=NONE gui=NONE cterm=NONE
  hi NeoTreeGitDeleted guifg=#A38665 guibg=NONE gui=NONE cterm=NONE
  hi NeoTreeGitUntracked guifg=#7AA5C2 guibg=NONE gui=NONE cterm=NONE
  ...
  hi WinBar guifg=#2F3B4B guibg=#FFFFFF gui=bold cterm=bold
  hi WinBarNC guifg=#324D67 guibg=#FFFFFF gui=NONE cterm=NONE
  hi ExplorerSnack guibg=#293E52 guifg=#FFFFFF gui=bold cterm=bold
  hi BufferTabpageFill guibg=#FFFFFF guifg=#376686 gui=NONE cterm=NONE
  ...
  hi BufferVisible guifg=#2F3B4B guibg=#FFFFFF gui=NONE cterm=NONE
  hi BufferVisibleMod guifg=#324D67 guibg=#FFFFFF gui=NONE cterm=NONE
  hi BufferVisibleSign guifg=#4B647D guibg=#FFFFFF gui=NONE cterm=NONE
  hi BufferInactive guifg=#376686 guibg=#FFFFFF gui=NONE cterm=NONE
...
hi FloatBorder guifg=#4B697D guibg=NONE gui=NONE cterm=NONE
hi SignColumn guifg=NONE guibg=NONE gui=NONE cterm=NONE
hi DiffAdd guifg=#FFFFFF guibg=#7A99C2 gui=NONE cterm=NONE
hi DiffChange guifg=#FFFFFF guibg=#658AA3 gui=NONE cterm=NONE
hi DiffDelete guifg=#FFFFFF guibg=#A38665 gui=NONE cterm=NONE
hi TabLineFill guifg=NONE guibg=NONE gui=NONE cterm=NONE

" Fix selection highlighting with proper color derivatives
hi TelescopeSelection guibg=#CCEAFF guifg=#2F3B4B gui=bold cterm=bold
hi TelescopeSelectionCaret guifg=#FFFFFF guibg=#CCEAFF gui=bold cterm=bold
hi TelescopeMultiSelection guibg=#9AC7E6 guifg=#2F3B4B gui=bold cterm=bold
hi TelescopeMatching guifg=#C2A07A guibg=NONE gui=bold cterm=bold

" Minimal fix for explorer selection highlighting
hi NeoTreeCursorLine guibg=#CCEAFF guifg=#2F3B4B gui=bold

" Fix for LazyVim menu selection highlighting
hi Visual guibg=#FFE7CC guifg=#2F3B4B gui=bold
hi CursorLine guibg=NONE ctermbg=NONE gui=underline cterm=underline
hi PmenuSel guibg=#FFE7CC guifg=#2F3B4B gui=bold
hi WildMenu guibg=#FFE7CC guifg=#2F3B4B gui=bold
...
augroup FixNeoTreeBackground
  ...
  autocmd ColorScheme,VimEnter * if &background == 'dark' |
    \ hi NeoTreeCursorLine guibg=#CCEAFF guifg=#2F3B4B gui=bold cterm=bold |
    \ hi NvimTreeCursorLine guibg=#CCEAFF guifg=#2F3B4B gui=bold cterm=bold |
    \ else |

...
present_terminal() {
  hyprshell launch/terminal-present.sh "$1"
}
...
show_learn_menu() {
  case $(menu "Learn" "  Keybindings\n  Hyprland\n󰣇  Arch\n  Neovim\n󱆃  Scripting\n  Waybar\n  Rofi\n  pywal16\n  MPD/rmpc\n  Ranger") in
    ...
    *Hyprland*) hyprshell launch/webapp.sh "https://wiki.hypr.land/" ;;
    *Arch*) hyprshell launch/webapp.sh "https://wiki.archlinux.org/title/Main_page" ;;
    *Neovim*) show_neovim_menu ;;
    *Scripting*) show_scripting_menu ;;
    *Waybar*) hyprshell launch/webapp.sh "https://github.com/Alexays/Waybar/wiki" ;;
    *Rofi*) hyprshell launch/webapp.sh "https://github.com/davatorium/rofi" ;;
    *pywal16*) hyprshell launch/webapp.sh "https://github.com/eylles/pywal16" ;;
    *"MPD/rmpc"*) hyprshell launch/webapp.sh "https://github.com/mierak/rmpc" ;;
    *Ranger*) hyprshell launch/webapp.sh "https://github.com/ranger/ranger/wiki" ;;
    *) show_main_menu ;;
  esac
}
...
show_bash_scripting_menu() {
  case $(menu "Bash Scripting" "󱆃  Bash Cheatsheet\n󰄬  ShellCheck\n  POSIX Shell\n󰅍  wl-clipboard\n  rofi\n  grim/slurp\n  wf-recorder\n󰂚  notify-send") in
    ...
    *rofi*) hyprshell launch/webapp.sh "https://github.com/davatorium/rofi/wiki" ;;
...
show_toggle_menu() {
  case $(menu "Toggle" "󰔎  Nightlight\n󱫖  Keep Awake\n󰍜  Top Bar") in
    *Nightlight*) hyprshell toggle/nightlight.sh ;;
    *Keep*) hyprshell session/toggle-keep-awake.sh ;;
    *Bar*) hyprshell toggle/waybar.sh ;;
    *) show_trigger_menu ;;
  esac
}
...
show_dev_tools_menu() {
  case $(menu "Dev Tools" "󰊢  Git (LazyGit)\n  Docker (LazyDocker)\n  File Manager (Ranger)\n󰻠  CPU Monitor (Htop)\n  GPU Monitor (Nvtop)\n  Disk Usage (Dua)\n  Music Player (Rmpc)") in
    ...
    *CPU*) xdg-terminal-exec --app-id=org.tui.Htop -e htop ;;
    *GPU*) xdg-terminal-exec --app-id=org.tui.Nvtop -e nvtop ;;
    *Disk*) xdg-terminal-exec --app-id=org.tui.Dua -e dua i ;;
    *Music*) xdg-terminal-exec --app-id=org.tui.Rmpc -e rmpc ;;
    *) show_main_menu ;;
  esac
}
...
show_search_all_menu() {
  ...
  add "Dev › CPU Monitor (Htop)" "xdg-terminal-exec --app-id=org.tui.Htop -e htop"
  add "Dev › GPU Monitor (Nvtop)" "xdg-terminal-exec --app-id=org.tui.Nvtop -e nvtop"
  add "Dev › Disk Usage (Dua)" "xdg-terminal-exec --app-id=org.tui.Dua -e dua i"
  add "Dev › Music Player (Rmpc)" "xdg-terminal-exec --app-id=org.tui.Rmpc -e rmpc"

  # Learn (from show_learn_menu)
  add "Learn › Keybindings" "hyprshell keybinds_hint.sh c"
  add "Learn › Hyprland" "hyprshell launch/webapp.sh https://wiki.hypr.land/"
  add "Learn › Arch" "hyprshell launch/webapp.sh https://wiki.archlinux.org/title/Main_page"
  add "Learn › Waybar" "hyprshell launch/webapp.sh https://github.com/Alexays/Waybar/wiki"
  add "Learn › Rofi" "hyprshell launch/webapp.sh https://github.com/davatorium/rofi"
  add "Learn › pywal16" "hyprshell launch/webapp.sh https://github.com/eylles/pywal16"
  add "Learn › MPD/rmpc" "hyprshell launch/webapp.sh https://github.com/mierak/rmpc"
  add "Learn › Ranger" "hyprshell launch/webapp.sh https://github.com/ranger/ranger/wiki"
  ...
  add "Learn › Scripting › Bash › rofi" "hyprshell launch/webapp.sh https://github.com/davatorium/rofi/wiki"
  ...
  add "Trigger › Toggle › Top Bar" "hyprshell toggle/waybar.sh"
